...
const userInfoForm = reactive({
  //reactive是vue3的响应式函数,用于将一个对象转换成响应式对象,这样,当对象中的属性发生变化时,就会触发视图的更新,和ref不同的是,ref是将一个基本类型的数据转换成响应式数据,而reactive是将一个对象转换成响应式对象
  username: "",
  password: "",
  remember: false,
});
...
.divider__text {
  color: #409eff;
  font-size: 14px; /* 字体大小 */
  padding: 0 10px; /* 文本与分割线的内边距 */
  position: relative; /* 相对定位，用于定位文本 */
  top: -10px; /* 负的top值，使文本与分割线有一定的重叠效果 */
